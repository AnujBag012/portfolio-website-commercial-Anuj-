...
export function Buttonbar() {
    return (
        <div className="flex justify-center mt-8">
            <div class="bg-[url('/bg-1.jpg')] md:h-20 lg:h-20 h-auto w-screen md:bg-contain lg:bg-contain bg-cover flex justify-center">
                <div className="grid md:grid-cols-4 lg:grid-cols-4 text-white gap-3">
