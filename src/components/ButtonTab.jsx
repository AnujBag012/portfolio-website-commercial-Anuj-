export function ButtonTab() {
    return (
        <div className="flex justify-center mt-8">
            <div class="bg-blue-950 md:h-96 lg:h-96 h-screen w-screen  flex justify-center">
                <div className="flex text-white gap-8">
                    <div className=" flex-col gap-3">
                        <a href="#" className="relative mb-5 w-48 group h-24 block bg-no-repeat bg-cover bg-center overflow-hidden rounded-md" style={{ backgroundImage: "url('/image--1.jpg')" }}>
                        ...
                        <a href="#" className="relative w-48 group h-24 block bg-no-repeat bg-cover bg-center overflow-hidden rounded-md" style={{ backgroundImage: "url('/image--1.jpg')" }}>
                            <div className="overlay absolute inset-0"></div>
                            <div className="relative p-2 z-20 flex justify-between">
                                <div className="flex flex-col ml-3">
                                    <div className="flex flex-col h-12">
                    ...
                    <div>
                        <a href="#" className="relative w-48  mb-5 group h-24 block bg-no-repeat bg-cover bg-center overflow-hidden rounded-md" style={{ backgroundImage: "url('/image--1.jpg')" }}>
