                        ...
                        <div className='mt-10'>
                            <form className="max-w-md mx-auto">
                                ...
                                <div className='flex justify-center items-center mb-2'>
                                    ...
                                    <span className='pl-2'>
                                        I accept the
                                        <a className='text-red-500 pl-2' href="//technohills.com/sonusharma/terms-and-conditions/" target="_blank">
                                            terms & condition
                                        </a>
                                    </span>
                                </div>
                                <div className='flex justify-center items-center pt-4'>
                                    <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm w-full sm:w-auto px-8 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
